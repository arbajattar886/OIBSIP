...
public class Task_1 {
	 ...
	 private static final int min = 1000;
	    ...
	    public static void main(String[] args) {
	        ...
	        String url = "jdbc:mysql://localhost:3306/IRCTC"; // change the database as 'vasu' as per your requirement
	        try {
	            ...
	            try (Connection connection = DriverManager.getConnection(url, username, password)) {
	                ...
	                while (true) {
	                    ...
	                    String DeleteQuery = "DELETE FROM Reservations WHERE prn_number = ?";
	                    ...
	                    if (choice == 1) {
	                        ...
	                        try (PreparedStatement preparedStatement = connection.prepareStatement(ShowQuery);
	                            ...
	                            while (resultSet.next()) {
	                                String pnrNumber = resultSet.getString("prn_number");
